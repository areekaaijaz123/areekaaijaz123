...
💡 Backend & Cloud Engineer specializing in building scalable distributed systems using Python, AWS, and microservices architecture.  
...
### ⚙️ Core Engineering Work (Real Systems)

#### 🔐 AWS Security & Infrastructure Hardening
- Migrated systems from static credentials → IAM roles + OIDC authentication  
...
#### 🎥 Video Processing Pipeline (System Design)
